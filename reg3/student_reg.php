...
$l = $_FILES["image"]["name"];
$m = $_FILES["certificate"]["name"];
$n = $_FILES["medcertificate"]["name"];
$o = $_FILES["adhaar"]["name"];
move_uploaded_file($_FILES["image"]["tmp_name"], "../images/" . $l);
move_uploaded_file($_FILES["certificate"]["tmp_name"], "../images/" . $m);
move_uploaded_file($_FILES["medcertificate"]["tmp_name"], "../images/" . $n);
move_uploaded_file($_FILES["adhaar"]["tmp_name"], "../images/" . $o);
...
VALUES (
NULL ,  '$a', '$b',  '$g',  '$h',  '$i',  '$l', '1',0
)";
    
$insert1="INSERT INTO  `smartdrive`.`stud_reg` (
`stud_id` ,
        ...
        $("#password").focus();
                         ...
                         <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="password" name="confirmpassword" id="confirmpassword" onblur="return Validate()"
                                           required >
...
<script type="text/javascript">
                        ...
                        <div class="input-group">
                             <label class="label">Certificate</label>
                                    <input class="input--style-4" type="file" name="certificate" id="certificate" onchange="validateImage()"  required>
                            <p id="op2"></p>
<script type="text/javascript">
                             function validateImage(){
                               var formData = new FormData();
                            ...
                            <div class="col-2">
                             ...
                             <label class="label">Adhaar</label>
                                    <input class="input--style-4" type="file" name="adhaar" id="adhaar" onchange="validateImage()" required>
                                    <p id="op3"></p>
<script type="text/javascript">
                             function validateImage(){
                               var formData = new FormData();
                                ...
                                <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Med Certificate</label>
                                    <input class="input--style-4" type="file" name="medcertificate" id="medcertificate" onchange="validateImage()" required>
                                       <p id="op4"></p>
<script type="text/javascript">
                             function validateImage(){
                               var formData = new FormData();
