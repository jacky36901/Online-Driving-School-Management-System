...
<!-- Mirrored from templates.aucreative.co/drive/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Sep 2019 04:38:36 GMT -->
<head>
...
<body class="animsition restyle-index">
	...
	<header>
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop">
				<div class="limiter-menu-desktop">
					...
					<!-- Logo desktop -->	
                <a href="index.php" class="logo"><!--<img src="images/icons/icon4.png" alt="IMG-LOGO" />-->
					...
					<div class="menu-desktop">
						<ul class="main-menu">
                            ...
                            <li>
								<a href="">Register</a>
								<ul class="sub-menu">
									<li><a href="./reg3/student_reg.php">Customer</a></li>
									<li><a href="./reg3/school_reg.php">School</a></li>
		...
		<div class="wrap-header-mobile">
			<!-- Logo moblie -->		
			<a href="index2.html" class="logo-mobile">
			<img src="images/icons/color-1.png" alt="IMG-LOGO">
			...
			<div id="rev_slider_1" class="rev_slider fullwidthabanner" data-version="5.4.5" style="display:none">
				<ul>
					...
					<li data-transition="fade">
					    ...
					    data-height="['auto']"
					    >Get world-class driving training at DriveOn and be a more confident driver. Learning driving and traffic rules that make you a better driver. 
					    </p> -->
					...
					<!-- Slide 2 -->
					<li data-transition="fade">
						<img src="images/slide-02.jpg" alt="IMG-SLIDE" class="rev-slidebg">
				...
				<div class="col-sm-9 col-md-7 col-lg-4 p-b-30 m-lr-auto">
					...
					<div class="block-1">
						<div class="wrap-pic-b1 wrap-pic-w">
							<img src="images/featured-01.jpg" alt="IMG-FEATURE">
						</div>
					...
					<div class="wrap-text-b1 bg-main op-09 trans-05 ">
							...
							<div class="wrap-para-b1 p-l-50 p-r-20 m-tt-20 ">
								<p class="s-txt1">
									Get world-class driving training at DriveOn and be a more confident driver. 
								</p>
							</div> 
					...
					<div class="item-slick-1">
						...
						<div class="wrap-person m-lr-auto flex-c-m animated">
							...
							<div class="wrap-info-person p-l-20">
								<span class="dis-block s-txt3">Mary Bailey</span>
								<span class="dis-block s-txt4">Chief Executive Officer, Envato</span>
							</div>
						</div>
					</div>
...
<!-- Mirrored from templates.aucreative.co/drive/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Sep 2019 04:42:35 GMT -->
</html>