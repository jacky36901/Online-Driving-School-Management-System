...
<div class="dashboard-main-wrapper">
	...
	<br><br><br><br>
    <body>
        <center>  <h1><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ATTENDANCE REPORT</b></h1></center>
        <br><br><br>    
    ...
    <form method="post" action="print_cust.php">
        ...
        <tr><td><input type="button" name="trn2"  Value="Date Wise Report" onclick="location.href='search_cust.php'"></td>
 <td>&nbsp;&nbsp;&nbsp;</td>
		<td><input type="button" name="trn1" Value="Individual Report" onclick="location.href='search_att.php'"></td>
		</tr>
