					...
					<div class="p-r-20 p-r-0-md">
						<div class="bo2">
							<div class="wrap-pic-w bo2-b">
								<img src="images/course-04.jpg" alt="IMG-COURSE">
							</div>
							...
							<div class="p-l-38 p-r-38 p-t-30 p-b-18 p-lr-15-sm">
								...
								<p class="s-txt2 p-b-24">
									A driving test is a procedure designed to test a person's ability to drive a motor vehicle. It exists in various forms worldwide, and is often a requirement to obtain a driver's license.A driving test is a procedure designed to test a person's ability to drive a motor vehicle. It exists in various forms worldwide, and is often a requirement to obtain a driver's license.A driving test is a procedure designed to test a person's ability to drive a motor vehicle. It exists in various forms worldwide, and is often a requirement to obtain a driver's license.A driving test is a procedure designed to test a person's ability to drive a motor vehicle. It exists in various forms worldwide, and is often a requirement to obtain a driver's license.
								</p>
