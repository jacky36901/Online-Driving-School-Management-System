...
<body>
    ...
    <div class="dashboard-main-wrapper">
        <img src="../images/sss.jpg" width=100% height=50%/>
        <!-- ============================================================== -->
        <!-- navbar -->
        <!-- ============================================================== -->
            ...
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-dark">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                     ...
                     <li class="nav-item ">
                                <a class="nav-link" href="course-list.php"><i class="fa fa-fw fa-user-circle"></i>courses<span class="badge badge-success"></span></a>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                   <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="slot_det.php">Approve Session</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="view_sess.php">View Session</a>
                                        </li> 
                                    </ul>
                                </div>
                            </li>
                            ...
                            <!-- <li class="nav-item ">
                                <a class="nav-link" href="test.php"><i class="fa fa-fw fa-user-circle"></i>Apply Test<span class="badge badge-success"></span></a>  -->     
                                 
                                 
                           
                                   
                                  <li class="nav-item ">
                                <a class="nav-link" href="feedback.php"><i class="fa fa-fw fa-user-circle"></i>Feedback<span class="badge badge-success"></span></a>
