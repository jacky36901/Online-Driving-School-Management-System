...
$time=$_POST['time'];     
 ...
 $sql89="update add_slot set date='$date', slot='$slot', place='$place' , time='$time' where slot_id='$d'"; 
    if(mysqli_query($con,$sql89))
    {
          echo "<script>";echo "alert('Successfully recheduled!')";echo"</script>";
         echo "<script>";
...
$sql0="select * from add_slot where slot_id='$d'";
$res00=mysqli_query($con,$sql0);
    $sql01="select * from add_slot where slot_id='$d'";
$res001=mysqli_query($con,$sql01);
...
<center><h4>SLOT RESCHEDULE</h4></center>
  <br>
  <br>
    ...
    <?php
            ...
            while($fetch=mysqli_fetch_array($res00))
            {
                 $op=$fetch['trainer_id'];
               $m=$fetch['stud_id'];
                $rr="select * from registeration where reg_id='$m'";
      ...
      <?php
                               while($fetch=mysqli_fetch_array($res001))
                               {
                                ?>
    
  <div class="row">
    <p><div class="name">Student</div><input class="input-field col-md-12" type="text" placeholder=" " name="student" id="student" value="<?php echo $res['name']?>"
                                          name="user_bio" id="user_bio"   onchange="validatetxt()"  readonly  required>
                         
			            <label class="errortext" style="display:nne; size:10PX; color:red" id="student"></label><br>
                                          ...
                                          <br>
        <div class="row">
    <p><div class="name">Trainer</div><input class="input-field col-md-12" type="text" placeholder=" " name="trainer_id" id="trainer_id" value="<?php echo $res2['name']?>"
                                          name="user_bio" id="user_bio"   onchange="validatetxt()"  readonly  required>
			            ...
			            <label class="errortext" style="display:nne; size:10PX; color:red" id="trainer_id"></label><br>
                                          ...
                                          <br>
      <div class="row">
    <p><div class="name">Date</div><input class="input-field col-md-12" type="date" placeholder=" " name="date" id="date" value="<?php echo $fetch['date'] ?>"
			            ...
			            <label class="errortext" style="display:nne; size:10PX; color:red" id="date"></label><br>
                                          ...
                                          <br>
        <div class="row">
    <p><div class="name">Vehicle Type</div><input class="input-field col-md-12" type="text" placeholder=" " name="veh_type" id="veh_type" value="<?php echo $fetch['veh_type'] ?>"
                                          name="user_bio" id="user_bio"   onchange="validatetxt()"  readonly  required>
			            ...
			            <label class="errortext" style="display:nne; size:10PX; color:red" id="veh_type"></label><br>
                                          ...
                                          <br>
                <div class="row">
    <p><div class="name">Vehicle Number</div><input class="input-field col-md-12" type="text" placeholder=" " name="veh_name" id="veh_name" value="<?php echo $fetch['veh_name'] ?>"
                                          name="user_bio" id="user_bio"   onchange="validatetxt()"  readonly  required>
                   ...
                   <div class="row">
    <p><div class="name">Slot</div><input class="input-field col-md-12" type="text" placeholder=" " name="slot" id="slot" value="<?php echo $fetch['slot'] ?>"
                                          name="user_bio" id="user_bio"   onchange="validatetxt()"  required>
                         
			            <label class="errortext" style="display:nne; size:10PX; color:red" id="slot"></label><br>
                   ...
                   <div class="row">
    <p><div class="name">Place</div><input class="input-field col-md-12" type="text" placeholder=" " name="place" id="place" value="<?php echo $fetch['place'] ?>"
                                          name="user_bio" id="user_bio"   onchange="validatetxt()"   required>
			            ...
			            <label class="errortext" style="display:nne; size:10PX; color:red" id="place"></label><br>
                                          ...
                                          <br>
        <div class="row">
    <p><div class="name">TIME</div><input class="input-field col-md-12" type="text" placeholder=" " name="time" id="time" value="<?php echo $fetch['time'] ?>"
                                          name="user_bio" id="user_bio"   onchange="validatetxt()"  required>
