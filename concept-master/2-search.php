...
$m=$_POST['name'];
$view="select * from registeration where  name LIKE '%$m%' ";
...
<form  action="2-search.php" method="POST">
    <center><br><br>
				<center><table class="table table-striped">
                    ...
                    <a class="theme-btn add-cart-btn"  href="shop-single.php?m=<?php echo $fetch['name'];?>">CLICK TO VIEW </a>
