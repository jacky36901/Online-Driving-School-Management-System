...
<div class="dashboard-main-wrapper">
    ...
    <form method="post" action="print_cust.php">
        ...
        <tr><td><input type="button" name="trn2"  Value="Trainer Wise Report" onclick="location.href='search_stud.php'"></td>
 <td>&nbsp;&nbsp;&nbsp;</td>
		<td><input type="button" name="trn1" Value="Full Report" onclick="location.href='ser_stud.php'"></td>
		</tr>
