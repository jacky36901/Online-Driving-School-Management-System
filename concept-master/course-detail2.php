...
<!-- Mirrored from templates.aucreative.co/drive/course-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Sep 2019 04:48:53 GMT -->
<head>
			...
			<!--<div class="flex-w flex-sb-m">  -->
				<div class="p-t-10 p-b-10 p-r-30">
					<!--<div class="flex-w p-b-9">
						<span>
							<a href="index-2.html" class="s-txt19 hov-color-main trans-02">
						...
						<span>
							<a href="course-list.php" class="s-txt19 hov-color-main trans-02">
								Our Courses
							</a>
							<span class="s-txt19 p-l-6 p-r-9"></span>
						</span>
					...
					<div class="p-r-20 p-r-0-md">
						<div class="bo2">
							<div class="wrap-pic-w bo2-b">
								<img src="images/course-02.jpg" alt="IMG-COURSE">
							</div>
							...
							<div class="p-l-38 p-r-38 p-t-30 p-b-18 p-lr-15-sm">
								...
								<p class="s-txt2 p-b-24">
									Advanced driving teaches drivers greater control of their vehicle, helping them to improve a range of motoring skills - including road positioning and handling. The aim is to develop drivers who are more considerate when out on the road, more confident and competent behind the wheel, and generally more observant.Advanced driving teaches drivers greater control of their vehicle, helping them to improve a range of motoring skills - including road positioning and handling. The aim is to develop drivers who are more considerate when out on the road, more confident and competent behind the wheel, and generally more observant.Advanced driving teaches drivers greater control of their vehicle, helping them to improve a range of motoring skills - including road positioning and handling. The aim is to develop drivers who are more considerate when out on the road, more confident and competent behind the wheel, and generally more observant.
								</p>
...
<!-- Mirrored from templates.aucreative.co/drive/course-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Sep 2019 04:48:55 GMT -->
</html>