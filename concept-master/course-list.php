...
<!-- Mirrored from templates.aucreative.co/drive/course-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Sep 2019 04:48:30 GMT -->
<head>
			...
			<div class="flex-w flex-sb-m">
				<div class="p-t-10 p-b-10 p-r-30">
					<!--<div class="flex-w p-b-9">
						...
						<span>
							<span class="s-txt19">
								<a href="student_home.php" class="s-txt19 hov-color-main trans-02">
	...
	<section class="bgwhite p-t-70 p-b-65">
		<div class="container">
						...
						<div class="block-3 bo2">
							...
							<div class="wrap-text-b3 p-l-20 p-r-20 p-t-16 p-b-26">
								...
								<div class="wrap-btn-b3 flex-w p-t-13">
									...
									<div class="p-t-8">
										<!-- Button -->
										<a href="course-detail.php" class="btn-drive m-txt10 size4 bo3 bg1 hov-color-white bo-rad-4">
											Detail
										</a>
									</div>
								</div>
			...
			<div class="js-list">
				<div class="row">
					<div class="col-sm-10 col-md-12 m-lr-auto p-b-30">
						...
						<div class="block-3 bo2 flex-w">
							<div class="wrap-pic-b3 wrap-pic-w hov5 bo2-r w-size6 respon2">
								<a href="course-detail.php"><img src="images/course-01.jpg" alt="IMG-COURSE"></a>
							</div>
							...
							<div class="wrap-text-b3 w-size7 p-l-35 p-r-27 p-t-26 p-b-25 w-full-md">
								...
								<h4 class="p-b-15">
									<a href="course-detail.php" class="m-txt8 hov-color-main trans-04">
										Learners
									</a>
								</h4>
								
								<p class="s-txt2 h-size4 of-hidden m-b-2 respon3">
									Students who come to driving schools have to first go through theoretical sessions which tell them about the basics of road signs.
								</p>
					...
					<div class="col-sm-10 col-md-12 m-lr-auto p-b-30">
						...
						<div class="block-3 bo2 flex-w">
							<div class="wrap-pic-b3 wrap-pic-w hov5 bo2-r w-size6 respon2">
								<a href="course-detail2.php"><img src="images/course-02.jpg" alt="IMG-COURSE"></a>
							</div>
							...
							<div class="wrap-text-b3 w-size7 p-l-35 p-r-27 p-t-26 p-b-25 w-full-md">
								...
								<h4 class="p-b-15">
									<a href="course-detail2.php" class="m-txt8 hov-color-main trans-04">
										Advanced
									</a>
								</h4>
								
								<p class="s-txt2 h-size4 of-hidden m-b-2 respon3">
									Advanced driving teaches drivers greater control of their vehicle, helping them to improve a range of motoring skills - including road positioning and handling. The aim is to develop drivers who are more considerate when out on the road, more confident and competent behind the wheel, and generally more observant.
								</p>
					...
					<div class="col-sm-10 col-md-12 m-lr-auto p-b-30">
						...
						<div class="block-3 bo2 flex-w">
							<div class="wrap-pic-b3 wrap-pic-w hov5 bo2-r w-size6 respon2">
								<a href="course-detail.php"><img src="images/course-03.jpg" alt="IMG-COURSE"></a>
							</div>
							...
							<div class="wrap-text-b3 w-size7 p-l-35 p-r-27 p-t-26 p-b-25 w-full-md">
								...
								<h4 class="p-b-15">
									<a href="course-detail3.php" class="m-txt8 hov-color-main trans-04">
										Learners and Advanced
									</a>
								</h4>
								
								<p class="s-txt2 h-size4 of-hidden m-b-2 respon3">
									Students who come to driving schools have to first go through theoretical sessions which tell them about the basics of road signs as well as .Advanced driving teaches drivers greater control of their vehicle, helping them to improve a range of motoring skills.
								</p>
					...
					<div class="col-sm-10 col-md-12 m-lr-auto p-b-30">
						...
						<div class="block-3 bo2 flex-w">
							<div class="wrap-pic-b3 wrap-pic-w hov5 bo2-r w-size6 respon2">
								<a href="course-detail.php"><img src="images/course-04.jpg" alt="IMG-COURSE"></a>
							</div>
							...
							<div class="wrap-text-b3 w-size7 p-l-35 p-r-27 p-t-26 p-b-25 w-full-md">
								...
								<h4 class="p-b-15">
									<a href="course-detail4.php" class="m-txt8 hov-color-main trans-04">
										Driving  Test
									</a>
								</h4>
								
								<p class="s-txt2 h-size4 of-hidden m-b-2 respon3">
									A driving test is a procedure designed to test a person's ability to drive a motor vehicle. It exists in various forms worldwide, and is often a requirement to obtain a driver's license.
								</p>
			...
			<!--	<div class="flex-w flex-m p-t-15">
					<a href="#" class="flex-c-m s-txt24 size14 bgwhite bo6 bo-rad-3 hov3 trans-03 m-r-12 m-t-5 m-b-5 act-pagi">
						1
					</a>

					<a href="#" class="flex-c-m s-txt24 size14 bgwhite bo6 bo-rad-3 hov3 trans-03 m-r-12 m-t-5 m-b-5">
						2
					</a>
...
<!-- Mirrored from templates.aucreative.co/drive/course-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Sep 2019 04:48:53 GMT -->
</html>