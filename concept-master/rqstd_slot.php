...
<head>
    ...
    <br>
    <br>
        <center><h2 style="color:blue"><b style="font-size:25px;"></b>REQUESTED SLOTS</h2></center>
      <center>   
...
$sql="select * from registeration where user_type=1 && status=1";
...
<center><h2 style="color:blue"><b style="font-size:25px;">REQUESTED SLOTS</b></h2></center>
<form method="POST">
    <br><br>
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="rqstd_slot2.php?b=<?php echo $fetch['username'];?>">
