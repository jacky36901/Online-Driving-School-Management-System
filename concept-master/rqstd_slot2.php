...
<head>
    ...
    <br>
    <br>
        <center><h2 style="color:blue"><b style="font-size:25px;">REQUESTED SLOT DETAILS</b></h2></center>
        <?php  
...
$sql0="select distinct stud_id from rqst_slot";
$res00=mysqli_query($con,$sql0);
    ...
    $op=$fetch['stud_id'];
$sql2="select * from rqst_slot where stud_id='$op' && status=2";
 ...
 <?php
                   ...
                   <?php
                    while($fetch2=mysqli_fetch_array($exe2))
                     ...
                     <tr><td></td><td></td><td><b style="font-size:15px;">Date :</b></td><td style="font-size:15px;"><?php echo $fetch2['rdate']?>
                                  
                                   </td>
							</tr>
                    
                     <tr><td></td><td></td><td><b style="font-size:15px;">Slot :</b></td><td style="font-size:15px;"><?php echo $fetch2['rslot']?>
                                  
                                   </td>
							</tr>
                    
                     <tr><td></td><td></td><td><b style="font-size:15px;">Time :</b></td><td style="font-size:15px;"><?php echo $fetch2['rtime']?>
...
<a href="tappr.php?m=<?php echo $a;?>"><font color="blue"><b style="font-size:15px;">Approve</b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<a href="tdelr.php?b=<?php echo $a;?>"><font color="red"><b style="font-size:15px;">Remove</b></font></a></td>
