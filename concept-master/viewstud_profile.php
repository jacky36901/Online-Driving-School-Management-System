...
<center><h2 style="color:blue"><b style="font-size:35px;">VIEW PROFILE</b></h2></center>
<form method="POST">
    <center><br><br>
				<center><table class="table table-striped">
                    ...
                    <tr><td></td><td></td><td align="right"><b style="font-size:15px;">Pincode :</b></td><td style="font-size:15px;"><?php echo $fetch['pin']?>
                     ...
                     <tr><td></td><td></td><td align="right"><b style="font-size:15px;">District :</b></td><td style="font-size:15px;"><?php echo $fetch['dist_id']?>
                    ...
                    while($fetch2=mysqli_fetch_array($exe2))
						{
                        $op=$fetch2['school_id'];
                        $sql4="select * from school_reg where username='$op'";
                        $exe4=mysqli_query($con,$sql4);  
                        $fetch4=mysqli_fetch_array($exe4);

							?>
                     <tr><td></td><td></td><td align="right"><b style="font-size:15px;">School :</b></td><td style="font-size:15px;"><?php echo $fetch4['name']?>
