...
$sql0="select * from add_slot where username='$a'and status1='0'";
$res00=mysqli_query($con,$sql0);

?>
<br>
  <h1 style="color:cyan;font-size:45px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ATTENDANCE</h1>
...
<tr><td><?php echo $fetch['stud_id'];?></td><td><?php echo $fetch['date'];?></td><td><?php echo $fetch['veh_type'];?></td><td><?php echo $fetch['veh_name'];?></td><td><?php echo $fetch['slot'];?></td><td><?php echo $fetch['place'];?></td><td><?php echo $fetch['time'];?></td><td><?php echo $m;?></td><td style="font-size:14px;"><a href="attadd.php?b=<?php echo $fetch['slot_id'];?>">Attended</a></td><td style="font-size:14px;"><a href="attdel.php?b=<?php echo $fetch['slot_id'];?>">Not Attended</a></td></tr>
            <?php
