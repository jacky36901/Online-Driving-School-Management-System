...
$sql="select * from test_date where school_id='$a'";
  ...
  <form method="post" class="form" style="max-width:500px; margin:auto">
    <br><br>
        <table class="table table-striped" width=50% align="center">
            <tr><td colspan="4"><center><h2 style="color:green">TEST DATES</h2></center></td></tr>
            <tr><th>DATE 1</th><th>DATE 2</th><th>DATE 3</th><th>DATE 4</th></tr>
      <?php
                               while($fetch=mysqli_fetch_array($res))
                               {
                                ?>          
       <tr><td><?php echo $fetch['test_1'];?></td><td><?php echo $fetch['test_2'];?></td><td><?php echo $fetch['test_3'];?></td><td><?php echo $fetch['test_4'];?></td></tr>
