...
include('connection.php');
    $user=$_SESSION['sess'];        
$sql="select * from feedback where school_id='$user'";
$exe=mysqli_query($con,"$sql");
?>
        

<center><h1 style="color:blue"><b style="font-size:25px;">FEEDBACK</b></h1></center>
<form method="POST">
    <br><br>
			<center>	<table  class="table table-striped">
					...
					<tbody>
						...
						{
                             $op=$fetch['name'];
                            $sql2="select * from stud_reg where username='$op'";
						...
						<tr>
							...
							<td style="font-size:15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $fetch2['name']?></td>
							
													
							<td><a href="feedbackview2.php?b=<?php echo $fetch['name'];?>">
