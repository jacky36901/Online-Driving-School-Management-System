...
?>
                 <h2 style="color:green">SCHOOL DETAILS</h2>
  <form method="post">
    <br><br>
        <table class="table table-striped" width=100% border="1">
            <tr><th rowspan="2">NAME</th><th align="center" colspan="4">ADDRESS</th><th align="center" colspan="4">FEE DETAILS</th></tr>
            <tr><th>BUILDING NAME</th><th>PLACE</th><th>DISTRICT</th><th>IMAGE</th><th>LEARNERS</th><th>ADVANCED</th><th>LEARNERS AND ADVANCED</th><th>DRIVING TEST</th></tr>
            
                                    
            <?php
            $sql="select * from registration where user_type='3' and status='1'";
            ...
            while($fetch=mysqli_fetch_array($res))
            {
                ...
                $rr2="select * from fee where username='$op'";
                $q2=mysqli_query($con,$rr2);
                $res2=mysqli_fetch_array($q2);
                
                
            ?>
            <tr><td><?php echo $fetch['name']?></td><td><?php echo $fetch['hname']?></td><td><?php echo $fetch['place'] ?></td><td><?php echo $fetch['dis'] ?></td><td><img src="../images/<?php echo $fetch['image']?>" width="200" height="200"></td><td><?php echo $res2['Learners'] ?></td><td><?php echo $res2['Advanced'] ?></td><td><?php echo $res2['Learners_n_Advanced'] ?></td><td><?php echo $res2['Driving_test'] ?></td>
                                    </tr>
            <?php
            }
            ?>
       ...
       <button type="button" class="btn btn-primary" name="submit"  value="Back" onclick="document.location='studprofile_complete.php'"><b>BACK</b></button>
           </form>
