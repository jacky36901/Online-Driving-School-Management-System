		...
		if(isset($_POST['search']))
{
   ...
   // $txtStartDate=$_POST['txtStartDate'];
    ...
    $query="select * from add_slot where stud_id='$trn' ";
...
<div style="font-size:23px;align:center;">
...
<?php
            $rr="select * from registration where username='$trn'";
                $q=mysqli_query($con,$rr);
                $res=mysqli_fetch_array($q);
        
    echo "<div style='font-size:25px;'>Student Name:".$res['name']."</div>";
        
        ?>
    <table border="1" width=100%>
         
        <tr><th>TRAINER</th><th>DATE</th><th>VEHICLE TYPE</th><th>VEHICLE No.</th><th>SLOT</th><th>PLACE</th><th>TIME</th></tr>
            ...
            $rr2="select * from add_trainer where trainer_id='$op'";
                ...
                $res2=mysqli_fetch_array($q2);
					...
					<tr><td><?php echo $res2['name']?><td><?php echo $fetch['date']?></td><td><?php echo $fetch['veh_type'] ?></td><td><?php echo $fetch['veh_name'] ?></td><td><?php echo $fetch['slot'] ?></td><td><?php echo $fetch['place'] ?></td><td><?php echo $fetch['time'] ?></td>
					<?php 
					}
