...
$a=$_GET['b'];
$sql="select feedback from feedback where name='$a'";
$exe=mysqli_query($con,$sql);

?>
<center><h2 style="color:blue"><b style="font-size:25px;">VIEW FEEDBACK</b></h2></center>
<form method="POST">
    <center><br><br>
				<center><table class="table table-striped">
					<?php
                     ...
                     <tr><td></td><td></td><td><b style="font-size:15px;">Feedback :</b></td><td style="font-size:15px;"><?php echo $fetch['feedback']?>
                                   </td>
							</tr>
