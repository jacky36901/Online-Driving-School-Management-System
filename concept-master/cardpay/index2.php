...
$slo=mysqli_query($con,"select * from school_reg where username='$m'");
$rec2=mysqli_fetch_array($slo);
$recipient=$rec2['school_id'];
$tyu2=mysqli_query($con,"select * from bank where stud_id='$recipient'");
...
if(isset($_POST['submit'])){
    ...
    if($count==1){
      ...
      $qw3=mysqli_query($con,"update bank set balance='$credit' where stud_id='$recipient'");
                         ...
                         <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                   <p style="color:green"> The OTP has been sent  successfully to your registered mail.</p>
