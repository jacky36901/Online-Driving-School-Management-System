...
<body>
    ...
    <div class="dashboard-main-wrapper">
        <img src="../images/aaa.jpg" width=100% height=50%/>
        ...
        <div class="nav-left-sidebar sidebar-light">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-dark">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu"  bg="white" style="">
                                    <ul class="nav flex-column">
                                      ...
                                      <li class="nav-item">
                                            <a class="nav-link" href="profile_complete.php">Profile Complete</a>
                                        </li> 
                                        <li class="nav-item">
                    ...
                    <li class="nav-item ">
                                <a class="nav-link" href="stud_list.php"><i class="fa fa-fw fa-user-circle"></i>Student list<span class="badge badge-success"></span></a> 
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                   <ul class="nav flex-column">
                                       <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="add_slot2.php">Add slot</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="view_sess2.php">Attendance</a>
                                        </li> 
                                        <li class="nav-item">
                                            <a class="nav-link" href="view_sess3.php">Slot details</a>
                                        </li> 
                                    </ul>
                                </div>
                            </li>
                    ...
                    <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fa fa-fw fa-user-circle"></i>Reprts</a>
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        
                                        <li class="nav-item">
                                            <a class="nav-link" href="prn_att.php">Attendance</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="search_trn.php">Trainer</a> 
                                        </li>
                                         <li class="nav-item">
                                            <a class="nav-link" href="search_stud.php">Student</a> 
                                        </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="feedbackview.php"><i class="fa fa-fw fa-user-circle"></i>Feedback<span class="badge badge-success"></span></a>       
                                    
                               
                           <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-4"><i class="fas fa-cog mr-2"></i>Settings</a>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">School Home Page</h2>
                                 <img src="../images/image.jpg" width=100% height=50%/>
