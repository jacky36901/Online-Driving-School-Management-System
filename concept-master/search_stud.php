...
$sq3="select * from add_trainer where school_id='$user'";
...
<div class="dashboard-main-wrapper">
    ...
    <body>
        ...
        <br><br><br>
    <div style="position:relative;left:520px;top:0px;border:groove;width:500px;height:200px;" >
    <form method="post" action="print_stud.php">
		<table style="position:relative;top:20px;left:40px;height:100px;width:400px;">
            <tr><td align="right"><font color="red">TRAINER NAME:</font> </td>
		<td>
    ...
    while($fetch=mysqli_fetch_array($me2))
						{
                            ?>
               <option value="<?php echo $fetch['trainer_id']?>"><?php echo $fetch['name']?>  <?php
                        }
?></option>>
                    </select></div></td>
		</tr>
