...
<!-- Mirrored from d29u17ylf1ylz9.cloudfront.net/driveon-preview-v1/driveon-light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2019 15:52:13 GMT -->

<!-- Mirrored from file:///C:/My Web Sites/driveon/d29u17ylf1ylz9.cloudfront.net/driveon-preview-v1/driveon-light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Aug 2019 09:24:29 GMT -->
<head>
	<meta charset="utf-8">
	<meta http-equiv="x-ua-compatible" content="ie=edge">
	<title>Home || Driveon</title>
			...
			<div class="row justify-content-between">
				...
				<div class="main-menu mean-menu col-auto">
					...
					<!--		<li><a href="about.html">about</a></li>-->
                       ...
                       <!--  <li><a href="./login/index.php">Login</a></li>
                              <li><a href="./login/index.php">Login</a></li> <li><a href="./login/index.php">Login</a></li>                       								
                        <!--   <li><a href="#">Register<i class="icofont icofont-simple-right"></i></a>
										<ul>
                                            <li><a href="./register/student_reg.php">Student</a></li>
											<li><a href="./register/school_reg.php">School</a></li>
											<li><a href="./register/trainer_reg.php">Trainer</a></li> 
                                       </ul>
						...
						<!--	<li><a href="#">features<i class="icofont icofont-simple-down"></i></a>
							...
							<li><a href="gallery.html">gallery<i class="icofont icofont-simple-down"></i></a>
								<ul>
		...
		<div class="slide-table container"> 
			<div class="table-cell">
				<div class="hero-slide-content float-right text-right">
					<center><h3 class="wow fadeInUp" data-wow-duration=".9s" data-wow-delay="0.8s">welcome to drive on</h3></center>
...
<div class="style-customizer closed">
	<div class="buy-button">
		<a href="index.html" class="customizer-logo"><img src="img/logo-dark.png" alt="Theme Logo"></a>
		<!--<a class="opener" href="#"><i class="icofont icofont-gear"></i></a>--> <a class="button button-border" href="https://themeforest.net/item/driveon-driving-school-html-template/19233401?ref=AslamHasib">Buy now!</a> 
	</div>
...
<!-- Mirrored from d29u17ylf1ylz9.cloudfront.net/driveon-preview-v1/driveon-light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Aug 2019 15:52:37 GMT -->
