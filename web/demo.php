   ...
   <body class="game_info" data-spy="scroll" data-target=".header">
                                 ...
                                 <nav class="navbar navbar-inverse">
                                    ...
                                    <div class="collapse navbar-collapse js-navbar-collapse">
                                       <ul class="nav navbar-nav">
                                          ...
                                          <li><a href="team_registration.php"><b>Team Registration</b></a></li>
                                          <li><a href="sponsor_registration"><b>Sponsor Registration</b></a></li>
                                          <li class="dropdown mega-dropdown">
                                             <a href="match" class="dropdown-toggle" data-toggle="dropdown"><b>Match</b><span class="caret"></span></a>				
                     ...
                     <div class="carousel-caption">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                           <div class="slider-contant" data-animation="animated fadeInRight">
                             <br><br><br>
                               <br><h3>If you Don’t Practice<br>You <span class="color-yellow">Don’t Derserve</span><br>to win!</h3>
      ...
      <footer id="footer" class="footer">
                  ...
                  <div class="full">
                     <div class="footer-widget">
                        <div class="footer-logo">
                           <a href="#"><img src="images/torneo_logo.png" alt="#" /></a>
                        </div>
                  ...
                  <div class="full">
                     <div class="footer-widget">
                        ...
                        <ul class="address-list">
                           <li><i class="fa fa-map-marker"></i> Torneo, let the tournament begin..</li>
                           <li><i class="fa fa-phone"></i> 123 456 7890</li>
                           <li><i style="font-size:20px;top:5px;" class="fa fa-envelope"></i> torneo@gmail.com</li>
                        </ul>
                     </div>
                  </div>
               </div>
         ...
         <div class="footer-bottom">
            <div class="container">
               <p>Copyright © 2019 Torneo.All rights reserved.</p>
            </div>
         </div>
      </footer>
