...
<body class="">
        ...
        <ul class="navbar-nav ">
          ...
          <li class="nav-item">
            <a class="nav-link " href="student_approve.php">
              <i  class="ni ni-single-02 text-yellow"></i> Approve Student
            </a>
          </li>
          <li class="nav-item">
            ...
            <a class="nav-link " href="active_user.php">
              <i  class="ni ni-single-02 text-green"></i> Active Students
            </a>
          </li>
             <li class="nav-item">
            <a class="nav-link " href="active_school.php">
              <i  class="ni ni-single-02 text-green"></i> Active Schools
            </a>
          </li>
              <li class="nav-item">
            <a class="nav-link " href="blocked_users.php">
              <i  class="ni ni-single-02 text-red"></i> Blocked Students
            </a>
          </li>
            <li class="nav-item">
            <a class="nav-link " href="blocked_school.php">
              <i  class="ni ni-single-02 text-red"></i> Blocked Schools
            </a>
          </li>
           
            <li class="nav-item ">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="ni ni-single-02 text-blue"></i>Reports<span class="badge badge-success"></span></a>
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="prn_stud.php">Student</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="sch_school.php">School</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="prn_trn.php">Trainer</a>
                                        </li>
                                    </ul>
  ...
  <div class="main-content">
    ...
    <div class="header bg-gradient-dark pb-16 pt-5 pt-md-8">
      <img src="assets/img/brand/driv.jpg" width=100%/>
      </div>
      <!-- Footer -->
      <footer class="footer">
