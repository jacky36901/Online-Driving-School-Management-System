...
$sql="select * from registration where user_type=1 && status=9";
...
<center><h2 style="color:blue"><b style="font-size:25px;">Removed Students</b></h2></center>
<form method="POST">
    <br><br>
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="user_view3.php?b=<?php echo $fetch['username'];?>">
