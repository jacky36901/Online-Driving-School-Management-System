...
<center><h1>TRAINER REPORT</h1></center>
    ...
    <div style="position:relative;left:220px;top:0px;border:groove;width:500px;height:200px;" class="prn" >
    
		<table style="position:relative;top:20px;left:40px;height:100px;width:400px;">
            
        <tr>		<td><input type="button" name="trn2"  Value="Schoolwise Trainer Report" onclick="location.href='search_trainer.php'"></td>
 <td>&nbsp;&nbsp;&nbsp;</td>
		<td><input type="button" name="trn1" Value="Full Trainer Report" onclick="location.href='search_trn.php'"></td>
		</tr>
        </table>
              </div>
            </div>
