...
$sql="select * from registration where user_type=3 && status=9";
...
<center><h2 style="color:blue"><b style="font-size:25px;">Removed Schools</b></h2></center>
<form method="POST">
    <br><br>
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="user_view33.php?b=<?php echo $fetch['username'];?>">
