...
<center><h1>STUDENT REPORT</h1></center>
    ...
    <div style="position:relative;left:220px;top:0px;border:groove;width:500px;height:200px;" class="prn" >
        ...
        <tr>		<td><input type="button" name="trn2"  Value="Schoolwise Student Report" onclick="location.href='search_student.php'"></td>
 <td>&nbsp;&nbsp;&nbsp;</td>
		<td><input type="button" name="trn1" Value="Full Student Report" onclick="location.href='search_stud.php'"></td>
		</tr>
        </table>
              </div>
            </div>
