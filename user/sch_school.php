...
<center><h1>SCHOOL REPORT</h1></center>
	
	<br><br>
    <body>
    <div style="position:relative;left:220px;top:0px;border:groove;width:500px;height:150px;" >
    <form method="post" action="print_school.php">
		<table style="position:relative;top:20px;left:50px;height:100px;width:300px;">
