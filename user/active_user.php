          ...
          <div class="form-group mb-0">
            ...
            <div class="input-group-prepend"> 
                <span class="input-group-text">
                    ...
                    <button type="submit" name="submit" style="background-color:inherit; color:white; border-color:inherit" > <i class="fas fa-search"></i> </button>
...
$sql="select * from registration where user_type=1 && status=1 or status=5";
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="student_view2.php?b=<?php echo $fetch['username'];?>">
