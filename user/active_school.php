...
if(isset($_POST['submit'])) {
    $nl=$_POST['search'];
    header("location:search_school.php?b=".$nl);
}
?>
          ...
          <div class="form-group mb-0">
            ...
            <div class="input-group-prepend"> 
                <span class="input-group-text">
                  <button type="submit" name="submit" style="background-color:inherit; color:white; " > <i class="fas fa-search"></i> </button>
...
$sql="select * from registration where user_type=3 && status=1";
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="school_view2.php?b=<?php echo $fetch['username'];?>">
