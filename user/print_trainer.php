		...
		if(isset($_POST['search']))
{
    ...
    $query="select * from add_trainer where school_id='$tran' AND jdate between'$txtStartDate'and'$txtEndDate' order by jdate";
...
<div style="font-size:25px;align:center;">
        ...
        {
            ?>
    <br><b><?php echo $fetch1['name']?></b><br>
        ...
        ?>
				...
				<table border="1" width="100%">
                    ...
                    <tr><th>NAME</th><th>HOUSE NAME</th><th>PLACE</th><th>DISTRICT</th><th>PINCODE</th><th>PHONE NUMBER</th><th>EMAIL ID</th><th>GENDER</th><th>DATE OF JOIN</th></tr>
					
					<?php  while($fetch=mysqli_fetch_array($tbl))
                                                    {
                                            ?>
					<tr><td><?php echo $fetch['name']?></td><td><?php echo $fetch['hname']?></td><td><?php echo $fetch['place'] ?></td><td><?php echo $fetch['dis'] ?></td><td><?php echo $fetch['pin'] ?></td><td><?php echo $fetch['phone'] ?></td><td><?php echo $fetch['email'] ?></td><td><?php echo $fetch['gender'] ?></td><td><?php echo $fetch['jdate'] ?></td>
